...
const data = [
  { lightone: "images/img_group_6.svg", lighttwo: "Light" },
  { lightone: "images/img_instagram.svg", lighttwo: "AC" },
  { lightone: "images/img_computer.svg", lighttwo: "TV" },
  { lightone: "images/img_calendar.svg", lighttwo: "Fridge" },
  { lightone: "images/img_lock_white_a700.svg", lighttwo: "Security" },
  { lightone: "images/img_thermometer.svg", lighttwo: "Heating" },
];
...
export default function DesktopTwoPage() {
  return (
    <>
      <Helmet>
        <title>EnergiTrack by Firsthing - Advanced Energy Management</title>
        <meta
          name="description"
          content="Elevate your energy efficiency with EnergiTrack. Firsthing's flagship product offers real-time monitoring and automated savings with smart switch modules and sensors."
        />
      </Helmet>
      ...
      <div className="flex w-full flex-col items-center bg-white-A700">
        {/* navigation section */}
        <div className="h-[787px] self-stretch bg-[url(/public/images/img_group_33.png)] bg-cover bg-no-repeat md:h-auto">
          <div className="bg-gradient4 pb-[125px] md:pb-5">
            {/* header section */}
            <div className="flex flex-col items-center">
              <header className="flex items-start justify-between gap-5 self-stretch bg-gradient5 p-[26px] md:flex-col sm:p-5">
                <Img
                  src="images/img_header_logo.png"
                  alt="headerlogo_one"
                  className="mb-[65px] ml-10 h-[64px] w-[19%] object-cover md:ml-0 md:w-full"
                />
                <div className="mr-[54px] mt-3 flex items-center gap-10 md:mr-0 md:flex-col">
              ...
              {/* hero section */}
              <div className="container-sm flex flex-col items-start px-10 md:p-5 sm:px-5">
                <div className="flex w-[92%] items-start justify-between gap-5 md:w-full md:flex-col">
                  <div className="mt-[60px] flex w-[55%] flex-col items-start gap-10 md:w-full">
                    <Heading size="2xl" as="h1" className="uppercase leading-[70px]">
                      Leading the Way in IoT-Based Energy Management
                    </Heading>
                    <Button shape="round" className="min-w-[215px] !rounded-[14px] font-inter font-bold sm:px-5">
                      Explore Our Products
                    </Button>
                  </div>
                  <div className="w-[23%] rounded-[25px] border-2 border-solid border-black-900_04 bg-black-900_4c p-3.5 md:w-full">
                    <div className="mb-[13px] flex flex-col items-center gap-[25px]">
                      <div className="flex w-[37%] items-center gap-[9px] md:w-full">
                        <div className="h-[15px] w-[15px] rounded-[7px] border-2 border-solid border-black-900_04" />
                        <div className="h-[13px] flex-1 rounded-md border-2 border-solid border-black-900_04" />
                      </div>
                      <div className="flex flex-col items-center self-stretch">
                        <div className="grid grid-cols-2 justify-center gap-3 self-stretch md:grid-cols-1">
                          {data.map((d, index) => (
                            <div
                              key={"desktoptwo" + index}
                              className="flex w-full flex-col items-center gap-1 rounded-[5px] border border-solid border-black-900_04 bg-black-900_72 px-[9px] pb-[9px]"
                            >
                              <Img src={d.lightone} alt="light_one" className="h-[56px] w-[56%]" />
                        ...
                        <div className="mt-7 w-[26%] rounded-[27px] border border-solid border-white-A700 md:w-full">
                          <div className="h-[46px] w-[46px] rounded-[23px] bg-white-A700" />
                        </div>
                        <Text size="md" as="p" className="mt-2 text-center">
                          Off
                        </Text>
                      </div>
                    </div>
        ...
        {/* about section */}
        <div className="relative h-[654px] self-stretch md:h-auto">
